...
###########################################
PATH_TO_LLM = {
    'Qwen25': 'my_affectgpt/models/Qwen2.5-7B-Instruct',
    'Qwen3': 'my_affectgpt/models/Qwen3-8B',
}

PATH_TO_VISUAL = {
    'CLIP_VIT_LARGE': 'my_affectgpt/models/clip-vit-large-patch14',
}

PATH_TO_AUDIO = {
    'HUBERT_LARGE':  'my_affectgpt/models/chinese-hubert-large',
}
...
###################################################
DATA_DIR = {
    'MER2026':          '/opt/data/wlcc/mer2026-data',
}
PATH_TO_RAW_AUDIO = {
